...
adminCategoriesRouter.post("/", async (c) => {
  try {
    ...
    const themeColor = body.theme_color ? body.theme_color : '{"bg": "bg-black", "gradient": "from-gray-700 to-gray-500", "textHighlight": "text-white"}';
...
// .wrangler/tmp/bundle-d4omnz/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-d4omnz/middleware-loader.entry.ts
